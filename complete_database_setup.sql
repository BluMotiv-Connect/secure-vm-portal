...
SELECT 'Tables created, indexes added, functions/triggers installed' as message;
SELECT 'Views created for reporting' as message;
SELECT 'Sample admin users inserted' as message; 