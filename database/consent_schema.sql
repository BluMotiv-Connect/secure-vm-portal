-- ============================================================================
-- USER CONSENT AGREEMENT SYSTEM - DATABASE SCHEMA
-- ============================================================================
-- This script creates the database schema for the User Consent Agreement system
-- Ensures GDPR and DPDP Act 2023 compliance with proper audit trails
-- Version: 1.0.0
-- Created: 2025-01-27
...
-- Agreement versions table - stores different versions of the consent agreement
...
-- User consents table - records user consent for each agreement version
...
-- Consent audit log table - comprehensive audit trail for compliance
CREATE TABLE consent_audit_log (
    id SERIAL PRIMARY KEY,
    uuid UUID UNIQUE DEFAULT uuid_generate_v4(),
    user_id INTEGER REFERENCES users(id) ON DELETE SET NULL,
    user_email VARCHAR(255), -- Store email for audit even if user is deleted
...
-- Consent notifications table - track notifications sent to admins
CREATE TABLE consent_notifications (
    ...
    agreement_version VARCHAR(50),
    sent_to VARCHAR(255) NOT NULL, -- Admin email
...
BEGIN
    ...
    -- Get user's latest active consent
...
-- Updated at triggers for consent tables
...
-- Ensure single current version trigger
...
-- Insert initial agreement version with the provided content
...
SELECT 'Consent management schema setup completed successfully!' as message;